                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/1.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/USA.png')}}" alt="USA" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/2.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/Brazil.png')}}" alt="Brazil" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/3.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/India.png')}}" alt="India" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/France.png')}}" alt="France" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/5.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                        <span class="avatar-status badge-success"></span>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/Spain.png')}}" alt="Spain" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{URL::to('public/img/avatars/6.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                        <span class="avatar-status badge-danger"></span>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{URL::to('public/img/flags/Poland.png')}}" alt="Poland" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
