                        ...
                        <div class="card-body">
                            <form action="{{URL::to('forms/register-students')}}" method="post" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="hf-Name" name="name" class="form-control" placeholder="Enter Name.." value="{{$student->name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="hf-name">EMAIL</label>
                                    <div class="col-md-9">
                                        <input type="text" id="hf-Name" name="email" class="form-control" placeholder="Enter Email.." value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="hf-Ocupation" name="ocupation" class="form-control" placeholder="Enter Ocupation.." value="{{$student->ocupation}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="hf-email">INSTITUTE NAME</label>
                                    <div class="col-md-9">
                                        <input type="text" id="hf-Institute" name="institute" class="form-control" placeholder="Enter Institute Name.." value="{{$student->institute}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="hf-email">ACADEMIC QUALIFICATION</label>
                                    <div class="col-md-9">
                                        <input type="text" id="hf-academic-qualification" name="academic_qualification" class="form-control" placeholder="Enter Academic Qualification.." value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="hf-mobile-no" name="phone_no" class="form-control" placeholder="Enter Phone No.." value="{{$student->phone_no}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <a href="{{URL::to('/tables/interested-students')}}"><button type="button" class="btn btn-secondary">Cancel</button></a>
                        </div>
                    </div>
                </div>
            </div>
